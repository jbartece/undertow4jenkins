...
\chapter{Jenkins CI a související nástroje}
    ...
    \section {Jenkins CI} \label{jenkins}
        ...
        \subsection{Základy práce s Jenkins CI} \label{jenkinsUsage}
            ...
            komunikuje pomocí protokolu TCP na portu 8080. Je tedy možné se na lokálním počítači připojit do aplikace zadáním URL adresy 
            \texttt{http://localhost:8080} do webového prohlížeče. 

            Pokud se aplikaci povede spustit, tak již je možné libovolně pracovat pouze s prohlížeče. Detaily práce s aplikací Jenkins CI
