...
\chapter{Jenkins CI a~související nástroje}
    ...
    \section{Server Undertow} \label{undertow}
        Undertow je nový webový server, který vzniká za podpory sekce JBoss (firma Red Hat),
        ...
        Informace v této kapitole jsou čerpány z webových stránek projektu \cite{undertowWeb}.
        Jelikož je aplikace poměrně nová, tak k ní existuje jen poměrně nedostatečná 
        dokumentace. Některé informace z této kapitoly musely být čerpány z
        vygenerované projektové dokumentace.
        ...
        \subsection{Vlastnosti serveru}
            ...
            jen tu část aplikace, kterou potřebuje a patřičně si ji upravit
        ...
        %V budoucnu rozšířit - jít více do hloubky
        \subsection{Praktický způsob využití serveru}
            ...
            se se serverem Undertow pracuje.
...
public class HelloWorldServer {
  ...
  public static void main(final String[] args) {
    ...
    server.start();
            ...
            Pro zjednodušení implementace při zpracovávání
            požadavků poskytuje Undertow entitu \texttt{HttpServerExchange},
            která je abstrakcí nad samotnou fyzickou podobou
            komunikace. Díky tomu na této úrovni uživatel nemusí řešit, 
            zda pracuje např. s HTTP nebo HTTPS.
