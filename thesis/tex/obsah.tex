...
\chapter{Jenkins CI a~související nástroje}
    ...
    \section {Jenkins CI} \label{jenkins}
        ...
        \subsection{Architektura serveru}   \label{secJenkinsArchitektura}
            ...
            a~data aplikace. Každý model je přímo navázán na konkrétní URL s~tím, že kořenový
            ...
            servlet kontejneru při spuštění aplikace.
            Pojmy servlet a~servlet kontejner jsou blíže vysvětleny v~kapitole \ref{servletKontejner}.
            Povědomí o~jeho
...
public class HelloWorldServer {
  ...
  public static void main(final String[] args) {
    ...
    server.start();
            ...
            odeslání provede metoda pomocí entity \texttt{HttpServerExchange},
