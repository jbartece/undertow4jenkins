...
\chapter{Jenkins CI a související nástroje}
    ...
    \section{Server Undertow} \label{undertow}
        ...
        \subsection{Srovnání serverů Undertow a Jetty}\label{srovnani}
            ...
            \medskip
            Provedeme srovnání serverů Undertow a Jetty a jejich výhod a nevýhod
            vzhledem k využití v systému Jenkins CI:
            \begin{itemize}
                \item {\textbf{Rychlost:} Server Undertow je ve velmi ranném stádiu, ale už přesto existují
                    i testy, které prokazují, že je výkonnější než server Jetty. V tomto           
                    ...
                    integrace uskutečníme vlastní porovnání těchto dvou implementací a pokusíme se potvrdit
                    tyto výsledky.}

                \item{\textbf{Rychlost spuštění:} }
                \item{\textbf{Spolehlivost:}}
                \item{\textbf{Konfigurovatelnost:}}
                \item{\textbf{Velikost:}}
