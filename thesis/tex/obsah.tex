...
\chapter{Jenkins CI a související nástroje}
    ...
    \section{Webový server a servlet kontejner} \label{servletWebserver}
        ...
        \subsection{Servlet kontejner}
            \begin{figure}[ht]
                \begin{center}
                    \scalebox{0.7}{\includegraphics{img/servlet-container-life-cycle.jpg}}
                    \caption{Ukázka způsobu činnosti servlet kontejneru \cite{webserverVsServletPage}}
                    \label{imgWebserver}
                \end{center}
            \end{figure}


        Co je servlet kontejner a webserver? 
