...
\chapter{Jenkins CI a související nástroje}
    ...
    \section{Webový server a servlet kontejner} \label{servletWebserver}
        ...
        jejich znalosti by některé kapitoly byly těžko pochopitelné.
    ...
    \section{Winstone} \label{winstone}
        Winstone je servlet kontejner, který je velmi jednoduchý a poskytuje funkcionalitu
        ...
        \subsection{Nedostatky servlet kontejneru Winstone}
            ...
            vývoj nových technologií jako webové sokety\footnote{Oficiální stránky 
            specifikace webových soketů http://www.websocket.org/}(angl. \emph{websocket}).

        \subsection{Vývoj v komunitě Jenkins CI}
