...
\chapter{Analýza současného stavu a návrh integrace}
    ...
    \section{Zpětná kompatibilita servlet kontejner v Jenkins CI}
        ...
        \subsection{Funkcionality servlet kontejneru}
            ...
            \begin{itemize}
                \item{\textbf{Komunikovat nešifrovaným protokolem HTTP}}
                \item{\textbf{Komunikovat šifrovaným protokolem HTTPS}}
            ...
            Po integraci serveru Jetty do kontejneru byla přidána ještě možnost
    ...
    \section{Návrh způsobu integrace serveru Undertow}
        ...
        \subsection{Zjištěné problémy}
            ...
            Undertow neobsahuje SPDY, ale plánuje to
